 ...
 *
 * The COMPLETE, VERBATIM text of YouTube's Terms of Service, inlined from the
 * human-readable source at ./youtube-tos.txt in the repo root. Nothing is
 * paraphrased, reordered, or summarised — the constant below is byte-identical
 * to that file (line endings normalised, trailing whitespace trimmed).
 *
 * To update: edit ./youtube-tos.txt, then re-inline it here.
 *
...
export const DEMO_AGREEMENT = `TERMS OF SERVICE
